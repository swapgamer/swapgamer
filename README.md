...
- **Backend:** ASP.NET MVC, ASP.NET Core Web API, ASP.NET Core MVC, ADO.NET
- **Data Access:** Entity Framework Core, Entity Framework
- **Frontend:** React JS, Angular, Razor Pages
- **Databases:** SQL Server, Azure SQL
- **Security:** JWT Authentication, Role-Based Access Control (RBAC)
- **Azure:** App Services, Logic Apps, Service Bus, Key Vault, Data Factory, Application Insights
